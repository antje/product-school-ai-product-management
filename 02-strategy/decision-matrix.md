...
Measured in 30 days, without new instrumentation. **Prioritization time, 2 hours to 30 minutes:** the two hours today go on assembling a ranking from memory; with Juno drafting it the work becomes checking about 40 items against their cited sources at roughly 30 seconds each, so 20 minutes of review plus discussion. **Reversals under 10%:** ten percent of a 40 item backlog is 4, so at most four decisions re-opened per quarter, about one a fortnight instead of several a week.
